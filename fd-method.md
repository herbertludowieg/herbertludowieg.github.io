...
# A look at the finite difference method {#fd-method}
...
### Backward difference {#backw-diff}
...
### Central difference {#central-diff}
...
If we use equation \eqref{eq:five-point-coeff} for the five-point stencil we get,
